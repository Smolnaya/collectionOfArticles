...
def convertDate(value):
    ...
    if re.match(correctDay, value):
        ...
        return date(int(result.group(3)), int(result.group(2)), int(result.group(1)))
    ...
    if re.match(minutePattern, value):
        ...
        return (currentDate - minutes).date()
